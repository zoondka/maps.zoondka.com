...
More details of the various components & their configurations can be found in the [roles](https://github.com/zoondka/maps.zoondka.com/tree/master/roles) directory. 
